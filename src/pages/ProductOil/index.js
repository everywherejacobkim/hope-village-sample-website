...
const DogFood = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get('data/productOil/productOilData.json')
      .then((res) => {
  ...
  return (
    <>
      <div className="my-10">
        <h1 className="text-3xl font-bold">기름류</h1>
        <h1 className="text-sm font-bold bg-primary-action text-white mt-1 py-0.5">Oil Products</h1>
      </div>
      <div className="product-container">
        ...
        {productData.map((product) => (
          <Card style={{ width: '18rem' }} key={product.id} className="">
            <Card.Img
              variant="top"
              src={product.image}
              alt="#"
